...
let Participantes = ["João da Silva", "Manoel Junior", "Vanessa Pereira"];
let dataAtual = 21/12/2021;
let dataCadastro = 22/12/2021;
let idade = 18;
let qtdParticipantes;

if (dataCadastro > dataAtual) //verifica se a data de cadastro é posterior a data atual
{
    if (idade >= 18) // verifica se o participante é maior de idade
    {
        //listar participantes
        for(i = 0; i <= Participantes.length; i++)
        {
            console.log(Participantes[i]) //mostra o nome do participante na posição em que o indice "i" se encontra.

        }

        
        //Se ainda houver vaga, cadastra o participante
        if(Participantes.length < 100)
        {
            qtdParticipantes = Participantes.length;
            Participantes[qtdParticipantes + 1] = "José da Silva";
            console.log ("Parabéns, você foi cadastrado com sucesso!");
            console.log ("Exibindo lista atual de participantes:")
        ...
        {
            console.log("Sinto, muito! quantidade de vagas excedidas!");
        }
    ...
    {
        console.Log("Idade invalida, o participante precisa ter mais de 18 anos");
    }
}
